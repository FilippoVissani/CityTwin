...
/**
 * This object defines the behavior of Resource Guardian Actor that subscribes to Mainstay Actor events using the Receptionist pattern.
 */
object ResourceGuardianActor:
  /**
   * Generates new Resource Guardian Actor.
   * @param resourceActor the Resource Actor that will receive the Mainstay Actor events.
   * @return the behavior of Resource Guardian Actor.
   */
