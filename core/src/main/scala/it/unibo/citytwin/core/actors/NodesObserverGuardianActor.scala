...
/** This object defines the behavior of Nodes Observer Guardian Actor that subscribes to Mainstay
  * Actor and Resource Actor events using the Receptionist pattern.
  */
object NodesObserverGuardianActor:

  /** Generates new Nodes Observer Guardian Actor.
    * @param mainstay
    *   the Mainstay Actor that will receive the Mainstay Actor and Resource Actor events.
    * @return
    *   the behavior of Nodes Observer Guardian Actor.
    */
