...
class JsonParseTest extends AnyWordSpec with Matchers:
  ...
  "Parser" should {
    "Parse correctly a JSON string" in {
      ...
      JSONParser.jsonToMainstaysHistory(jsonString).map((x, y) => (x, y.toString)) shouldBe List((MainstayState(Some("akka://ClusterSystem@127.0.0.1:2551/user"), Some(true)), "2023-08-24T18:09:17.581426074"), (MainstayState(Some("akka://ClusterSystem@127.0.0.1:2551/user"), Some(true)), "2023-08-24T18:09:17.996343216"), (MainstayState(Some("akka://ClusterSystem@127.0.0.1:2551/user"), Some(true)), "2023-08-24T18:09:20.073069294"), (MainstayState(Some("akka://ClusterSystem@127.0.0.1:2551/user"), Some(true)), "2023-08-24T18:09:21.739939386"))
    }
  }
