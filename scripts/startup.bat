...
start cmd /k call ./river-monitor/target/river-monitor-0.1.0/bin/river-monitor-main.bat 2555
start cmd /k call ./river-monitor/target/river-monitor-0.1.0/bin/flood-sensor-main.bat 2556
start cmd /k call ./river-monitor/target/river-monitor-0.1.0/bin/view-main.bat 2557
